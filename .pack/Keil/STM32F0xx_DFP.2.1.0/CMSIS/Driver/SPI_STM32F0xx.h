 ...
 * $Revision:    V1.0
 *
 * Project:      SPI Driver definitions for STMicroelectronics STM32F0xx
 * -------------------------------------------------------------------------- */

#ifndef __SPI_STM32F0XX_H
#define __SPI_STM32F0XX_H
...
#define SPI1_GET_CLK                    HAL_RCC_GetPCLK1Freq
