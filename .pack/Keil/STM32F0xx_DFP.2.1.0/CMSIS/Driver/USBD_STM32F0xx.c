...
/*! \page stm32f0_usbd CMSIS-Driver USBD Setup
...
Peripheral Resource | STM32F072B-DISCO |
:-------------------|:-----------------|
USB Peripheral      | USB              |
D- Pin              | PA11             |
D+ Pin              | PA12             |
...
The STM32CubeMX configuration for STMicroelectronics STM32F072B-DISCO Board with steps for Pinout, Clock, and System Configuration are 
...
-----------------
  1. Under Connectivity open \b USB Configuration:
     ...
     - <b>NVIC Settings</b>: enable interrupts
          ...
          :-----------------------------------------|:--------|:-------------------
          USB global interrupt / USB wake-up inter..| \b ON   | 0
