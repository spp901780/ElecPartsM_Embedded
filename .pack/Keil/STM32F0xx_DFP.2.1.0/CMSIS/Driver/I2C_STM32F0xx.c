...
/*! \page stm32f0_i2c CMSIS-Driver I2C Setup
...
----------
  1. Configure peripheral
     - Peripherals \b I2C2: enable <b>I2C</b>

  2. Configure pins PB13 and PB14 as I2C2 peripheral alternative pins
     - Click in chip diagram on pin \b PB13 and select \b I2C2_SCL
     - Click in chip diagram on pin \b PB14 and select \b I2C2_SDA
...
Configuration tab
-----------------
  1. Under Connectivity open \b I2C2 Configuration:
     ...
     - <b>NVIC Settings</b>: enable interrupts
          ...
          I2C2 global interrupt                     | \b ON   | 0

     - \e optional <b>DMA Settings</b>: setup DMA transfers for Rx and Tx (DMA is optional)\n
       \b Add - Select \b I2C2_RX: Stream=DMA1 Stream 5, Direction=Peripheral to Memory, Priority=Low\n
          DMA Request Settings         | Label             | Peripheral | Memory
          :----------------------------|:------------------|:-----------|:-------------
          Mode: Normal                 | Increment Address | OFF        |\b ON
          .                            | Data Width        |\b Byte     | Byte
       \b Add - Select \b I2C2_TX: Stream=DMA1 Stream 4, Direction=Memory to Peripheral, Priority=Low\n
          DMA Request Settings         | Label             | Peripheral | Memory
          :----------------------------|:------------------|:-----------|:-------------
          Mode: Normal                 | Increment Address | OFF        |\b ON
          .                            | Data Width        |\b Byte     | Byte
     ...
     - <b>GPIO Settings</b>: review settings
          ...
          :--------|:--------------|:-------------|:------------|:-------------------|:------------|:------------|:----------
          PB13     | I2C2_SCL      | n/a          | Alternate ..| Pull-up            | High        | n/a         |.
          PB14     | I2C2_SDA      | n/a          | Alternate ..| Pull-up            | High        | n/a         |.
