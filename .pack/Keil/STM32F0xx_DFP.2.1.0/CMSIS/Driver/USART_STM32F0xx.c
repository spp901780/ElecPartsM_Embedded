...
/*! \page stm32f0_usart CMSIS-Driver USART Setup in Synchronous mode
...
USARTx_RESOURCE_ALLOC(7);
#endif

// USART8
#ifdef USART8_MODE_SYNC
USARTx_RESOURCE_ALLOC(8);
#endif
...
#endif
#ifdef USART7_MODE_SYNC
  if (husart->Instance == USART7) { usart = &USART7_Resources; }
#endif
#ifdef USART8_MODE_SYNC
  if (husart->Instance == USART8) { usart = &USART8_Resources; }
#endif
...
#ifdef USART7_MODE_SYNC
USARTx_EXPORT_DRIVER(7);
#endif

#ifdef USART8_MODE_SYNC
USARTx_EXPORT_DRIVER(8);
#endif
