...
#ifndef __USART_STM32F0XX_H
#define __USART_STM32F0XX_H
...
#ifdef MX_USART7
#if   (MX_USART7_VM == VM_SYNC)

// USART7 used in Synchronous mode
#define USART7_MODE_SYNC                1

// USART7 DMA USE
#ifdef MX_USART7_TX_DMA_Instance
  #define USART7_DMA_USE_TX             USART_DMA_USE_TX
#else
  #define USART7_DMA_USE_TX             0
#endif
#ifdef MX_USART7_RX_DMA_Instance
  #define USART7_DMA_USE_RX             USART_DMA_USE_RX
#else
  #define USART7_DMA_USE_RX             0
#endif
#define USART7_DMA_USE                  (USART7_DMA_USE_TX | USART7_DMA_USE_RX)
#endif
#endif

// USART8 Configuration
#ifdef MX_USART8
#if   (MX_USART8_VM == VM_SYNC)

// USART8 used in Synchronous mode
#define USART8_MODE_SYNC                1

// USART8 DMA USE
#ifdef MX_USART8_TX_DMA_Instance
  #define USART8_DMA_USE_TX             USART_DMA_USE_TX
#else
  #define USART8_DMA_USE_TX             0
#endif
#ifdef MX_USART8_RX_DMA_Instance
  #define USART8_DMA_USE_RX             USART_DMA_USE_RX
#else
  #define USART8_DMA_USE_RX             0
#endif
#define USART8_DMA_USE                  (USART8_DMA_USE_TX | USART8_DMA_USE_RX)
#endif
#endif
    ...
    defined(USART7_MODE_SYNC) ||        \
    defined(USART8_MODE_SYNC)
...
#ifdef USART7_MODE_SYNC
extern ARM_DRIVER_USART Driver_USART7;
#endif

#ifdef USART8_MODE_SYNC
