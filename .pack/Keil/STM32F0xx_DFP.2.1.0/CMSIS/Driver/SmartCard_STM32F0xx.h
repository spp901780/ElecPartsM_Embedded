 ...
 * $Revision:    V1.0
 *
 * Project:      SmartCard Driver definitions for STMicroelectronics STM32F0xx
 * -------------------------------------------------------------------------- */

#ifndef __SMARTCARD_STM32F0XX_H
#define __SMARTCARD_STM32F0XX_H
